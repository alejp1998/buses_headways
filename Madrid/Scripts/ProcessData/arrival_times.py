...
def get_arrival_times(df,threshold) :
    ...
    for day in range(days) :
        ...
        for line in lines :
            ...
            for dest in lines_dict[line]['destinations'] :
                ...
                for stop in lines_dict[line][direction]['stops'] :
    ...
    new_df = new_df.drop_duplicates(subset=['bus', 'stop', 'arrival_time'],keep='last')

    #Remove non-useful columns
    new_df = new_df[['line','destination','stop','bus','datetime','DistanceBus','estimateArrive','arrival_time']]
...
def main():
    ...
    arrival_times = get_arrival_times(buses_data_cleaned,45)
