...
layout = html.Div(className = '', children = [
    html.Div(className='box', children = [
        ...
        html.Div(className='columns',children=[
            html.Div(id='buses-pos-div' + location, className='column is-4', children=[
                dcc.Graph(
                    id = 'map' + location,
                    className = 'box',
            ...
            html.Div(id='time-series-hws-div' + location, className='column is-4', children=[
                dcc.Graph(
            ...
            html.Div(id='2d-time-series-hws-div' + location, className='column is-4', children=[
                dcc.Graph(
...
@app.callback(
    [
        Output('buses-pos-div' + location,'children')
    ],
    [
